...
const Tech = () => {
    return (
        <div className="Tech">  
          <h4>Stacks</h4> 
          <ul>
              <li><img className="django" src="https://www.jing.fm/clipimg/full/53-537670_python-png-file-python-logo-png.png" alt="Python"/><span className="python"> Python</span></li>
              <li><img className="django" src="https://1000logos.net/wp-content/uploads/2020/08/Django-Logo.png" alt=" Django"/> Django </li>
